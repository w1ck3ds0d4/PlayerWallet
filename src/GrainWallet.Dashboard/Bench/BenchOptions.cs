...
/// <summary>
/// Per-bench-run tuning. Defaults are short so the dashboard "Run" button feels interactive; the 5-minute production benchmark still lives in tests/GrainWallet.Tests.Load.
